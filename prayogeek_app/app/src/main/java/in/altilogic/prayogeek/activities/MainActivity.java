...
//    private LocationManager mLocationManager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        referTxt = findViewById(R.id.txt_points);

        referBtn = findViewById(R.id.btn_refer);
                ...
                .addOnSuccessListener(this, new OnSuccessListener<PendingDynamicLinkData>() {
                    ...
                    public void onSuccess(PendingDynamicLinkData pendingDynamicLinkData) {
                        ...
                        if (pendingDynamicLinkData != null) {
                            ...
                            Log.e("Recv DeepLink",deepLink.toString());

                            String referrerUid = deepLink.getQueryParameter("invitedby");
                            Log.e("referrerUid",referrerUid);

                            if(!referrerUid.equals(mFirebaseAuth.getUid())){
                                mFireBaseHelper.writeInvitedBy(referrerUid);
                            }
                        }
    ...
    public void genDynamicLink(){
        FirebaseUser user = FirebaseAuth.getInstance().getCurrentUser();
        String uid = user.getUid();
        String link = "https://www.google.com/?invitedby=" + uid; //example link

        DynamicLink dynamicLink = FirebaseDynamicLinks.getInstance().createDynamicLink()
                .setLink(Uri.parse(link))
                .setDomainUriPrefix("https://prayogeek.page.link")
                // Open links with this app on Android
                .setAndroidParameters(new DynamicLink.AndroidParameters.Builder(getPackageName()).setMinimumVersion(125).build())
                // Open links with com.example.ios on iOS
                .setIosParameters(new DynamicLink.IosParameters.Builder("com.example.ios").build())
                .buildDynamicLink();

        Uri dynamicLinkUri = dynamicLink.getUri();
        Log.e("D Link",""+dynamicLink.getUri());
    ...
    private void firebase_auth_init() {
        ...
        mAuthStateListener = firebaseAuth -> {
            ...
            if (user != null) {
                ...
                //Refer Points changeListener
                mFireBaseHelper.pointsChanges(referTxt);
            ...
            case RC_SIGN_IN:
                if (resultCode == RESULT_OK) {
                    ...
                    if (user != null) {
                        ...
                        //Add points field to db
                        mFireBaseHelper.userPoints();
                    }
                    ui_init();
